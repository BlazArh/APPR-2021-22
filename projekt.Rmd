...
Podatke, potrebne za analizo, sem uvozil z Wikipedie in spletne strani Numeo (podatki so oblike HTML in CSV). Potem sem te podatke prečistil in spremenil v obliko tidy data. Dobil sem 4 manjše tabele in jih združil v eno veliko.
